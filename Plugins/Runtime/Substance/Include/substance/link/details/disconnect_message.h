...
#ifndef _SUBSTANCE_LINK_DISCONNECT_MESSAGE_H
#define _SUBSTANCE_LINK_DISCONNECT_MESSAGE_H
...
*/
unsigned int link_handle_error_disconnect(unsigned int context);
...
#endif /* _SUBSTANCE_LINK_DISCONNECT_MESSAGE_H */