...
#ifndef _SUBSTANCE_LINK_CALLBACKS_H
#define _SUBSTANCE_LINK_CALLBACKS_H
...
unsigned int link_add_trampoline(substance_link_trampoline_fp trampoline);
...
unsigned int link_remove_trampoline(substance_link_trampoline_fp trampoline);

#if defined(__cplusplus)
}
#endif /* __cplusplus */

#endif /* _SUBSTANCE_LINK_CALLBACKS_H */
