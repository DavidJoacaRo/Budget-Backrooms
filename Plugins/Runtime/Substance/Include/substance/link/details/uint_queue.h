...
#ifndef _SUBSTANCE_LINK_UINT_QUEUE_H
#define _SUBSTANCE_LINK_UINT_QUEUE_H
...
typedef struct _link_uint_queue link_uint_queue_t;
...
unsigned int link_uint_queue_push(link_uint_queue_t *queue, unsigned int elem);
...
unsigned int link_uint_queue_pop(link_uint_queue_t *queue,
                                 unsigned int *retval);
...
link_uint_queue_t* link_uint_queue_create(uint32_t size);
...
unsigned int link_uint_queue_destroy(link_uint_queue_t *queue);

#if defined(__cplusplus)
}
#endif /* __cplusplus */

#endif /* _SUBSTANCE_LINK_UINT_QUEUE_H */
