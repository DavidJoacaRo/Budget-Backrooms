...
#ifndef _SUBSTANCE_LINK_DETAILS_COMMUNICATION_H
#define _SUBSTANCE_LINK_DETAILS_COMMUNICATION_H
...
unsigned int link_shutdown_comm_subsystem(void);

#if defined(__cplusplus)
}
#endif /* __cplusplus */

#endif /* _SUBSTANCE_LINK_DETAILS_COMMUNICATION_H */
